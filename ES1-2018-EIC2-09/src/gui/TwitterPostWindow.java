...
public class TwitterPostWindow extends JFrame{
	/**
	 * 
	 */
	...
	private JButton btnEnviarTweet;
	private TwitterUser twitter;

	public TwitterPostWindow(TwitterUser twitter) {
		this.twitter=twitter;
		open(700, 700, "Enviar Tweet");
		close();
	...
	private void open(int width, int height, String title) {
		...
		btnEnviarTweet = new JButton("Enviar Tweet");
		btnEnviarTweet.setBounds(267, 573, 125, 51);
		getContentPane().add(btnEnviarTweet);
	}
	...
	private void btnListener() {
		btnEnviarTweet.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				twitter.Post(conteudoDaResposta.getText());
				conteudoDaResposta.setText("");
				dispose();			}
		});
	}
	...
	public static void main(String[] args) {
		...
		TwitterPostWindow twp = new TwitterPostWindow(t);
	}
}
