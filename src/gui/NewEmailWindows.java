...
public class NewEmailWindows extends JFrame {
	...
	public NewEmailWindows(email email) {
		...
		String origem = email.getUsername();
		...
		conteudoDaResposta.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent me) {
				if (me.getButton() == MouseEvent.BUTTON1) {
					conteudoDaResposta.setText(null);
				}
			}
		});
		setVisible(true);
		...
		btnResponder.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				email.send(lblEndereoDestino.getText(), origem, /* password, */ lblAssunto.getText(),
						conteudoDaResposta.getText());
			}
		});
	}
