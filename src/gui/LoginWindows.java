...
public class LoginWindows extends JFrame {
	...
	public LoginWindows() {
		...
		textField.setText("testees@outlook.pt");
	...
	public void loginListener() {
		btnLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				dispose();
				email email = new email(textField.getText(), String.valueOf(passwordField.getPassword()));
				MainWindows mainWindows = new MainWindows(email);
				email.setMainWindow(mainWindows);
				email.searchEmail();
